...
export default function Signup() {
  ...
  return (
    <>
      <button>
        <h1 className="signup" type="button" onClick={() => setShowModal(true)}>
          Sign Up
        </h1>
      </button>
      {showModal ? (
            ...
            <div className="relative  w-full rounded-3xl my-6 mx-auto max-w-sm">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white">
                  ...
                  >
                    <span>
                      <svg
                        ...
                        className="text-gray-600 h-6 w-6 mt-3"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        <path
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  />
                  <input
                    className="w-full h-11 mt-4 text-left text-lg px-4 border border-gray-300 focus:outline-none rounded-md focus:border-8 focus:border-green-800 "
                    type="tel"
                    placeholder="Email"
                    value={email}
